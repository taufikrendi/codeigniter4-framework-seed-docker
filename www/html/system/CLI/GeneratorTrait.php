...
trait GeneratorTrait
{
    ...
    protected function execute(array $params): void
    {
        ...
        // contents from the templates, and then we'll do the necessary replacements.
     ...
     * with fallback to `$templates` when the defined view does not exist.
     */
